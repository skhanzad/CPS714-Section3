    ...
    <div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {plans.map((plan) => (
          <div
            key={plan.name}
            className={`relative bg-white dark:bg-gray-800 rounded-lg shadow-sm border-2 p-6 transition-all ease-out duration-200 hover:shadow-lg ${
              plan.popular
                ? "border-blue-500 dark:border-blue-400"
                : "border-gray-200 dark:border-gray-700"
            } ${plan.current ? "ring-2 ring-blue-200 dark:ring-blue-800" : ""}`}
          >
            {plan.popular && (
