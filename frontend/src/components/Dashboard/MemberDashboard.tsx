...
import { User, Bell, BellDot, LogOut, Calendar, Pyramid, Activity } from 'lucide-react';
...
type TabType = 'dashboard' | 'profile' | 'bookclasses' | 'facilities' | 'notifications' | 'gym-activity';
    ...
    <div className="flex flex-col h-screen bg-gray-900 overflow-hidden">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className={`p-button button-header ${activeTab === 'gym-activity' ? 'bg-gold-500/90 text-gray-900 shadow-lg' : 'general-button-hover'}`}>
      ...
      <main className="flex-1 overflow-y-auto">
        <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          {activeTab === 'gym-activity' && <GymCapacity />}
        </div>
      </main>
    </div>
  );
